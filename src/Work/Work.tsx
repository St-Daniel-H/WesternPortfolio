    ...
    <div id="Work">
      ...
      {condition && (
        <div id="deckContainer">
          <AnimatePresence>
            ...
            <Card
              key="2"
              src={"../../dist/Images/Projects/Project4.jpg"}
              section={refSection4}
              href="https://github.com/St-Daniel-H/WesternPortfolio"
            />
            <Card
              key="1"
              src={"../../dist/Images/Projects/Project5.jpg"}
              section={refSection5}
              href="https://github.com/St-Daniel-H/WeatherApp"
            />
            <Card
              key="3"
              src={"../../dist/Images/Projects/Project3.jpg"}
              section={refSection3}
              href="https://github.com/St-Daniel-H/UniProject"
            />
            <Card
              key="4"
              src={"../../dist/Images/Projects/Project2.jpg"}
              section={refSection2}
              href="https://github.com/St-Daniel-H/SocialNetwork"
            />
            <Card
              key="5"
              src={"../../dist/Images/Projects/Project1.jpg"}
              section={refSection1}
      ...
      <WorkSection>
        ...
        {condition ? (
          ...
          <Text>
            <MobileCard src="../../dist/Images/Projects/Project1.jpg" />
          </Text>
        )}
        <div
          style={{
      ...
      <WorkSection>
        ...
        {condition ? (
          ...
          <Text>
            <MobileCard src="../../dist/Images/Projects/Project2.jpg" />
          </Text>
        )}
        <div
          style={{
      ...
      <WorkSection>
        ...
        {condition ? (
          ...
          <Text>
            <MobileCard src="../../dist/Images/Projects/Project3.jpg" />
          </Text>
        )}
        <div
          style={{
      ...
      <WorkSection>
        ...
        {condition ? (
          ...
          <Text>
            <MobileCard src="../../dist/Images/Projects/Project5.jpg" />
          </Text>
        )}
        <div
          style={{
      ...
      <WorkSection>
        ...
        {condition ? (
          ...
          <Text>
            <MobileCard src="../../dist/Images/Projects/Project4.jpg" />
          </Text>
        )}
        <div
          style={{
